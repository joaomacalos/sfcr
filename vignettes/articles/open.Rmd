...
open4_1l %>%
  ...
  geom_line(aes(linetype = name))
```
This model obviously explode and I had to use the Gauss-Seilde solver and decrease the number of periods to find some solution to it (as they do in the book).
...
## Scenario: A perverse reaction function? The puzzling effect of interes rates revisited
