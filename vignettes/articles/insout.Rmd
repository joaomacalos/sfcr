...
insout_ext <- sfcr_set(
  ...
  # (note that the sfcr package does not evaluate defined in the global environment when setting the external variables.
...
I think that the correct definition shoud be:
