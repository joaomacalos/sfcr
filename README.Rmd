...
The `sfcr_random()` function accepts a random series generator function from the built-in package `stats` as its first argument (e.g., `rnorm()`), and any additional arguments to these functions can be passed in the sequence.
